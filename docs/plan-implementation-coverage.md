...
| 미래 데이터 누수 방지 | Partial | `forward_return_1/5/20` 생성은 시프트 기반으로 선행 수익률 타깃을 만들고([src/quant_research/features/price.py](/Users/donghyunkim/Documents/Quantitative-Trading/src/quant_research/features/price.py:21)), walk-forward는 선택 horizon 이상 effective gap/embargo와 label interval overlap 검사를 적용한다([src/quant_research/validation/walk_forward.py](/Users/donghyunkim/Documents/Quantitative-Trading/src/quant_research/validation/walk_forward.py:52)). 하지만 텍스트/SEC feature 공개시점 오프셋 같은 외부 이벤트 타임라인 가드는 계속 별도 강화 대상이다 |
...
| FinMA / FinGPT event extraction | Implemented | [FilingEventExtractor](/Users/donghyunkim/Documents/Quantitative-Trading/src/quant_research/models/text.py:45), [FinGPTEventExtractor](/Users/donghyunkim/Documents/Quantitative-Trading/src/quant_research/models/text.py:146) support local Transformers/PEFT generation, JSON schema validation, and deterministic fallback. FinGPT 런타임/양자화 경로/안전 플래그는 `PipelineConfig`를 통해 `fingpt` 경로에서만 주입됨 |
| FinGPT local runtime wiring (mac preference + single-load guard) | Implemented | [app.py](/Users/donghyunkim/Documents/Quantitative-Trading/app.py:43), [src/quant_research/pipeline.py](/Users/donghyunkim/Documents/Quantitative-Trading/src/quant_research/pipeline.py:74), [tests/test_pipeline.py](/Users/donghyunkim/Documents/Quantitative-Trading/tests/test_pipeline.py:72), [tests/test_app_smoke.py](/Users/donghyunkim/Documents/Quantitative-Trading/tests/test_app_smoke.py:69) |
...
| FinGPT runtime config 전달(warmup safety/defaults) | Implemented | [test_fingpt_runtime_settings_are_passed_only_for_fingpt_extractor](/Users/donghyunkim/Documents/Quantitative-Trading/tests/test_pipeline.py:72), [app smoke UI checks](/Users/donghyunkim/Documents/Quantitative-Trading/tests/test_app_smoke.py:33) |
