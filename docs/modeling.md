...
- FinGPT 기본 adapter: `FinGPT/fingpt-mt_llama2-7b_lora`
- FinGPT 기본 base model: `meta-llama/Llama-2-7b-hf`
...
FinGPT는 공식 repo 기준으로 base model에 LoRA adapter를 붙이는 구조다. base model 다운로드 권한과 Hugging Face 인증이 필요할 수 있다. 이 모델들은 feature 생성과 리포트 요약 보조에만 사용하며, 매매 판단은 하지 않는다.
